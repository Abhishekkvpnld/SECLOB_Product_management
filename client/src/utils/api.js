...
export const getProduct_api = `${BASE_URL}/product/get-product`;
export const favoriteToggle_api = `${BASE_URL}/product/fav-toggle`;
export const favoriteProduct_api = `${BASE_URL}/product/fav-product`;
export const allFavProducts_api = `${BASE_URL}/product/all-favProducts`;
export const allSubCategory_api = `${BASE_URL}/product/all-subCategory`;
